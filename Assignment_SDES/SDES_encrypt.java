...
class KeyGeneration
{
  ...
  void GenerateKeys(String inputkey )
  {
    ...
    this.key = key;
      ...
      permutationP10();
      System.out.println("P10: 3 5 2 7 4 10 1 9 8 6 ");
      Print.msg("After P10: ");
      Print.array(this.key,10);
      Print.msg("\n");
      Print.msg("\n");
      ...
      leftshiftLS1();
      Print.msg("After LS-1: ");
      Print.array(this.key,10);
      Print.msg("\n");
    
    
      this.k1 = permutationP8();
      System.out.println("P8: 6 3 7 4 8 5 10 9 ");
      Print.msg("K1: ");
...
class Encryption
{
  ...
  void InitialPermutation()
  {
    ...
    pt = temp;
    Print.msg("\n");
    System.out.println("IP: 2 6 3 1 4 8 5 7");
	 Print.msg("After IP: ");
     Print.array(this.pt,8);
	 Print.msg("\n");
	 Print.msg("\n");
  ...
  int[] mappingF(int[] R, int[] SK)
  {
    ...
    temp[6]  = R[3];
    temp[7]  = R[0];
    System.out.println("E/P: 4 1 2 3 2 3 4 1 ");
	 Print.msg("E/P on RH: ");
     Print.array(temp,8);
	 Print.msg("\n");
    ...
    temp[7] = temp[7] ^ SK[7];
	 ...
	 System.out.println("S0: 1 0 3 2");
	 System.out.println("    3 2 1 0");
	 System.out.println("    0 2 1 3");
	 System.out.println("    3 1 3 2");
	 System.out.println("S1: 0 1 2 3");
  ...
  int[] encrypt(String plaintext , int[] LK, int[] RK)
  {
	...
	pt = r2;
	 ...
	 Print.msg("After 2nd round: ");
     Print.array(this.pt,8);
	 Print.msg("\n");

	 
	InverseInitialPermutation();
	System.out.println("IP-1: 4 1 3 5 7 2 8 6 ");
	 Print.msg("Answer: ");
     Print.array(this.pt,8);
	 Print.msg("\n");
